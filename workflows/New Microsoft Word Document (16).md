# New Microsoft Word Document (16)

Source: New Microsoft Word Document (16).docx
...
const GREEN\_DARK = '\#15803d';

const RED = '\#ef4444';

const RED\_DARK = '\#991b1b';
...
  const TRACK\_W = 22;    // inner track width
...
  const KNOB\_TOP = checked ? PAD : H \- KNOB \- PAD;
...
        borderRadius: TRACK\_W / 2,

        background: checked

          ? \`linear\-gradient\(180deg, $\{GREEN\_DARK\} 0%, $\{GREEN\} 50%, \#4ade80 100%\)\`

          : \`linear\-gradient\(180deg, $\{RED\_DARK\} 0%, $\{RED\} 50%, \#f87171 100%\)\`,
