...
          avatarUrl=\{prefs\.avatar\_url\}

          avatarKind=\{prefs\.avatar\_kind\}

          fullName=\{prefs\.full\_name\}
...
        <input style=\{inputSty\} value=\{prefs\.full\_name || ''\} onChange=\{e => onChange\(\{ full\_name: e\.target\.value \}\)\} placeholder="Jane Smith" />
...
          <option value="America/New\_York">Eastern \(New York\)</option>
...
          <option value="America/Los\_Angeles">Pacific \(Los Angeles\)</option>
