...
        cta: "https://www\.sos\.state\.tx\.us/corp/forms\_option\.shtml",
...
  const totalSteps = SETUP\_STEPS\.reduce\(\(a, p\) => a \+ p\.steps\.length, 0\);
...
                  \{ platform: "Texas Secretary of State", priority: "🔴 Critical", url: "https://www\.sos\.state\.tx\.us/corp/forms\_option\.shtml", note: "Official LLC address" \},
