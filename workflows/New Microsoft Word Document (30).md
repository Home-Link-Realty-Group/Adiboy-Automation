...
  const kpiGoals = \{ calls\_made: 60, talk\_time\_hours: 3\.5, offers\_made: 3, contacts\_reached: 15 \};
...
          \{ key: "calls\_made", label: "Outbound Dials", goal: 60, icon: "📞", unit: "calls", note: "Must ring 3\+ times each" \},

          \{ key: "talk\_time\_hours", label: "Seller Talk Time", goal: 3\.5, icon: "⏱️", unit: "hrs", note: "3\.5–6 hrs = deals happen here" \},

          \{ key: "offers\_made", label: "Offers Made", goal: 3, icon: "💵", unit: "offers", note: "3–4 per day minimum" \},

          \{ key: "contacts\_reached", label: "Contacts Reached", goal: 15, icon: "🤝", unit: "contacts", note: "Live conversations" \},
