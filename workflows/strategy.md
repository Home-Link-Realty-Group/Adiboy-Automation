...
  add\_header Cache\-Control "public, max\-age=31536000, immutable, stale\-while\-revalidate=604800";

  add\_header ETag "\\"v1\-$\(date \+%s\)\\"";
...
  add\_header Cache\-Control "public, max\-age=2592000, stale\-while\-revalidate=604800";
...
  add\_header Cache\-Control "public, max\-age=3600, must\-revalidate";
...
4\. 📄 \`docs/CACHING\_STRATEGY\.md\` — This document
