...
    : \`Deal follow\-up — $\{entity\.property\_address || entity\.seller\_name\}\`;

  const defaultNotes = entityType === "lead"

    ? \`Lead: $\{entity\.name\}\\nPhone: $\{entity\.phone || "—"\}\\nAddress: $\{entity\.address || "—"\}\\nStatus: $\{entity\.status || "—"\}\\nNext Follow\-Up: $\{entity\.next\_followup\_date || "—"\}\`

    : \`Deal: $\{entity\.property\_address || "—"\}\\nSeller: $\{entity\.seller\_name || "—"\}\\nBuyer: $\{entity\.buyer\_name || "—"\}\\nStatus: $\{entity\.status || "—"\}\\nClosing: $\{entity\.closing\_date || "—"\}\`;
...
      linked\_entity: entity\.id,

      linked\_entity\_type: entityType,
...
          <span style=\{\{ fontWeight: 700 \}\}>Linked to \{entityType === "lead" ? "Lead" : "Deal"\}:</span> \{entityType === "lead" ? entity\.name : \(entity\.property\_address || entity\.seller\_name\)\}
