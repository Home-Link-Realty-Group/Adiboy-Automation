...
        await DailyKPI\.create\(\{ date: today, goal\_calls: 60, goal\_talk\_time: 3, goal\_offers: 3, \.\.\.kpiEdit \}\);
...
            \['calls\_made', '📞 Calls Made', 'goal\_calls', 60\],

            \['talk\_time\_hours', '⏱ Talk Time \(hrs\)', 'goal\_talk\_time', 3\],

            \['offers\_made', '💼 Offers Made', 'goal\_offers', 3\],

            \['followups\_completed', '✅ Follow\-Ups Done', null, null\],
