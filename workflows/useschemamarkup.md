...
  el\.setAttribute\('content', 'sOjZDcEDrTRL1I4\_sB3ssF9rNXmK2dt0\-xIC\-bg6CF8'\);
...
            \{ '@type': 'ContactPoint', contactType: 'customer service', telephone: PHONE\_RAW, email: EMAIL, availableLanguage: 'English', contactOption: 'TollFree', areaServed: 'US' \},

            \{ '@type': 'ContactPoint', contactType: 'sales', telephone: PHONE\_RAW, availableLanguage: 'English' \},
...
            target: \{ '@type': 'EntryPoint', urlTemplate: \`$\{SITE\}/GetOffer?address=\{search\_term\_string\}\` \},
...
    setMeta\('og:site\_name', COMPANY, true\);
...
          seller: \{ '@type': 'Organization', name: COMPANY, telephone: PHONE\_RAW \},
