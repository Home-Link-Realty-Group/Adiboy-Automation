...
          value=\{prefs\.email\_signature || ''\}

          onChange=\{e => onChange\(\{ email\_signature: e\.target\.value \}\)\}

          rows=\{5\}

          placeholder="— Jane Smith&\#10;Acme Real Estate LLC&\#10;\(555\) 123\-4567 · jane@acme\.com"
...
          value=\{prefs\.sms\_speed\_to\_lead\_text || ''\}

          onChange=\{e => onChange\(\{ sms\_speed\_to\_lead\_text: e\.target\.value \}\)\}
