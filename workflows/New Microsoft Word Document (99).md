...
import \{ PHONE\_RAW \} from "\./portalConstants";
...
              <a href=\{\`tel:$\{PHONE\_RAW\}\`\} style=\{\{ display: "inline\-block", padding: "12px 24px", background: "\#27ae60", borderRadius: 10, color: "\#fff", fontWeight: 700, textDecoration: "none" \}\}>📞 Expedite My Offer</a>
...
              <a href=\{\`tel:$\{PHONE\_RAW\}\`\} style=\{\{ padding: "14px", background: "\#f8fafc", border: "1px solid \#e2e8f0", borderRadius: 12, color: "\#0B1F45", fontWeight: 700, fontSize: 15, textDecoration: "none", textAlign: "center" \}\}>📞 I Have Questions First</a>
