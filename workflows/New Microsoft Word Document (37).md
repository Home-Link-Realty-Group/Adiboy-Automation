...
export const BP\_BG = '\#0d0d1a';

export const BP\_GOLD = '\#f4a300';

export const BP\_GRID = 'rgba\(244,163,0,0\.06\)';
...
            <path d="M 40 0 L 0 0 0 40" fill="none" stroke=\{BP\_GRID\} strokeWidth="0\.5" />

          </pattern>

          <marker id="bp\-arrow" markerWidth="10" markerHeight="8" refX="8" refY="4" orient="auto">

            <polygon points="0 0, 10 4, 0 8" fill=\{BP\_GOLD\} />
...
        <text x="500" y="32" textAnchor="middle" fill=\{BP\_GOLD\} fontSize="16" fontWeight="900" fontFamily="Arial" letterSpacing="2">\{title\}</text>
...
        <line x1="60" y1="62" x2="940" y2="62" stroke=\{BP\_GOLD\} strokeWidth="0\.5" strokeDasharray="4,4" opacity="0\.4" />

        \{children\}

        <line x1="60" y1=\{height \- 25\} x2="940" y2=\{height \- 25\} stroke=\{BP\_GOLD\} strokeWidth="0\.3" opacity="0\.3" />
...
      <circle cx=\{x \+ 18\} cy=\{y \+ h/2\} r="13" fill=\{BP\_GOLD\} />

      <text x=\{x \+ 18\} y=\{y \+ h/2 \+ 4\} textAnchor="middle" fill=\{BP\_BG\} fontSize="13" fontWeight="900" fontFamily="Arial">\{num\}</text>
...
export function BPDiamond\(\{ cx, cy, w = 100, h = 60, label, sub, color = '\#0f3460', stroke = BP\_GOLD \}\) \{
...
export function BPArrow\(\{ x1, y1, x2, y2, color = BP\_GOLD, label, dashed = false, kind = 'gold' \}\) \{
...
export function BPLabel\(\{ x, y, text, color = BP\_GOLD, fontSize = 10, anchor = 'start', bold = true \}\) \{
