...
\- Logo: 780KB \(JPEG\) — \`media\.base44\.com/images/public/\.\.\./341fa67b3\_generated\_image\.png\`
...
src="https://media\.base44\.com/images/public/69d48de0b96337e8cdc27f54/341fa67b3\_generated\_image\.png"
...
     <source srcSet=\{LOGO\_WEBP\} type="image/webp" />
...
   \- Convert all \`image\_url\` assets to WebP
...
   \- Add \`image\_url\_webp\` field to \`BlogPost\` entity \(optional backup\)
...
\- Add \`image\_url\_webp\` field to \`BlogPost\` entity schema
