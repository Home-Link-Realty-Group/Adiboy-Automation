...
        <Toggle value=\{prefs\.auto\_skip\_trace\} onChange=\{v => onChange\(\{ auto\_skip\_trace: v \}\)\} />
...
        <Toggle value=\{prefs\.auto\_lead\_score\} onChange=\{v => onChange\(\{ auto\_lead\_score: v \}\)\} />
...
        <Toggle value=\{prefs\.auto\_followup\_sequence\} onChange=\{v => onChange\(\{ auto\_followup\_sequence: v \}\)\} />
...
        <Toggle value=\{prefs\.auto\_buyer\_drip\} onChange=\{v => onChange\(\{ auto\_buyer\_drip: v \}\)\} />
...
        <Toggle value=\{prefs\.auto\_offer\_engine\} onChange=\{v => onChange\(\{ auto\_offer\_engine: v \}\)\} />
...
        <Toggle value=\{prefs\.auto\_social\_post\} onChange=\{v => onChange\(\{ auto\_social\_post: v \}\)\} />
