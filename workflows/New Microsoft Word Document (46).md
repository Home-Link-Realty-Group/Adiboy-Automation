...
          \{PROPERTY\_TYPES\.map\(pt => \(

            <div key=\{pt\.value\}

              role="radio"

              aria\-checked=\{form\.property\_type === pt\.value\}

              tabIndex=\{0\}

              onClick=\{\(\) => up\("property\_type", pt\.value\)\}

              onKeyDown=\{e => \(e\.key === "Enter" || e\.key === " "\) && up\("property\_type", pt\.value\)\}

              style=\{radioCard\(form\.property\_type === pt\.value\)\}>

              <span aria\-hidden="true" style=\{\{ fontSize: 20 \}\}>\{pt\.icon\}</span>

              <span style=\{\{ fontSize: 13, fontWeight: form\.property\_type === pt\.value ? 700 : 500, color: form\.property\_type === pt\.value ? R : "\#333" \}\}>\{pt\.label\}</span>
...
        \{errors\.property\_type && <div role="alert" style=\{errStyle\}>\{errors\.property\_type\}</div>\}
