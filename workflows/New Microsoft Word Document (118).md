...
        <Toggle value=\{prefs\.notify\_new\_lead\_email\} onChange=\{v => onChange\(\{ notify\_new\_lead\_email: v \}\)\} />
...
        <Toggle value=\{prefs\.notify\_new\_lead\_sms\} onChange=\{v => onChange\(\{ notify\_new\_lead\_sms: v \}\)\} />
...
        <Toggle value=\{prefs\.notify\_hot\_lead\_only\} onChange=\{v => onChange\(\{ notify\_hot\_lead\_only: v \}\)\} />
...
        <Toggle value=\{prefs\.notify\_daily\_digest\} onChange=\{v => onChange\(\{ notify\_daily\_digest: v \}\)\} />
...
        <input type="time" value=\{prefs\.digest\_time\} onChange=\{e => onChange\(\{ digest\_time: e\.target\.value \}\)\} style=\{inputSty\} />
...
        <Toggle value=\{prefs\.quiet\_hours\_enabled\} onChange=\{v => onChange\(\{ quiet\_hours\_enabled: v \}\)\} />

      </SettingRow>

      \{prefs\.quiet\_hours\_enabled && \(

        <>

          <SettingRow title="Quiet Hours Start">

            <input type="time" value=\{prefs\.quiet\_hours\_start\} onChange=\{e => onChange\(\{ quiet\_hours\_start: e\.target\.value \}\)\} style=\{inputSty\} />

          </SettingRow>

          <SettingRow title="Quiet Hours End">

            <input type="time" value=\{prefs\.quiet\_hours\_end\} onChange=\{e => onChange\(\{ quiet\_hours\_end: e\.target\.value \}\)\} style=\{inputSty\} />
