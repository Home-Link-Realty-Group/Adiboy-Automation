...
        <select value=\{prefs\.dialer\_lines\} onChange=\{e => onChange\(\{ dialer\_lines: parseInt\(e\.target\.value\) \}\)\} style=\{inputSty\}>
...
        <input value=\{prefs\.dialer\_caller\_id || ''\} onChange=\{e => onChange\(\{ dialer\_caller\_id: e\.target\.value \}\)\} style=\{inputSty\} placeholder="\+15555551234" />
...
        <Toggle value=\{prefs\.dialer\_record\_calls\} onChange=\{v => onChange\(\{ dialer\_record\_calls: v \}\)\} />
...
        <Toggle value=\{prefs\.dialer\_recording\_disclosure\} onChange=\{v => onChange\(\{ dialer\_recording\_disclosure: v \}\)\} />
...
        <Toggle value=\{prefs\.dialer\_amd\_enabled\} onChange=\{v => onChange\(\{ dialer\_amd\_enabled: v \}\)\} />
...
        <Toggle value=\{prefs\.dialer\_voicemail\_drop\} onChange=\{v => onChange\(\{ dialer\_voicemail\_drop: v \}\)\} />
