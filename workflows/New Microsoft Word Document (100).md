...
import \{ PHONE, PHONE\_RAW, DOCS\_CHECKLIST \} from "\./portalConstants";
...
        \{DOCS\_CHECKLIST\.map\(\(section, si\) => \(
...
          <p style=\{\{ color: "\#1e3a5f", fontSize: 13, margin: 0, lineHeight: 1\.6 \}\}>The title company will walk you through exactly what you need before your closing appointment\. If you have questions, call us at <a href=\{\`tel:$\{PHONE\_RAW\}\`\} style=\{\{ color: "\#2563eb", fontWeight: 700 \}\}>\{PHONE\}</a>\.</p>
