...
const PRE\_FORECLOSURE\_SOURCES = \[
...
const HOT\_FORECLOSURE\_MARKETS = \[
...
  "name,phone,email,address,city,state,zip,auction\_date,mortgage\_balance,situation,source,notes\\n" \+
...
            lead\.auction\_date && \`Auction: $\{lead\.auction\_date\}\`,

            lead\.mortgage\_balance && \`Mortgage: $$\{lead\.mortgage\_balance\}\`,
...
          is\_pre\_foreclosure: true,

          seller\_motivation\_score: 9,
...
    \{ label: "Sources Available", value: PRE\_FORECLOSURE\_SOURCES\.length, icon: "📡", color: "\#ef4444" \},

    \{ label: "Hot Markets", value: HOT\_FORECLOSURE\_MARKETS\.length, icon: "🔥", color: "\#f97316" \},
...
            \{PRE\_FORECLOSURE\_SOURCES\.map\(src => \(
...
            \{HOT\_FORECLOSURE\_MARKETS\.map\(\(m, i\) => \(
...
          <CSVDropzone onFile=\{handleCSVUpload\} csvText=\{csvText\} onPaste=\{handlePaste\} template=\{CSV\_TEMPLATE\} accent="\#ef4444" />
