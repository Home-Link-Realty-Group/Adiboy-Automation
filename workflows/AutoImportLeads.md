...
        const searchUrl = \`https://$\{market\.slug\}\.craigslist\.org/search/rea?query=motivated\+seller\+as\-is\+fixer\+must\+sell&sort=date&housing\_type=6\`;
...
              score\_distress: scores\.distress,

              score\_urgency: scores\.urgency,

              score\_condition: scores\.condition,

              score\_equity: scores\.equity,

              motivation\_total\_score: totalScore,

              dom\_at\_contact: domDays,

              notes: \`Auto\-imported from Craigslist\.\\nPrice: $\{listing\.price || "Unknown"\}\\nListed: $\{listing\.postDate || "Unknown"\}\\nURL: $\{url\}\\n\\n$\{listing\.body\.slice\(0, 500\)\}\`,

              next\_followup\_date: new Date\(\)\.toISOString\(\)\.split\("T"\)\[0\],
