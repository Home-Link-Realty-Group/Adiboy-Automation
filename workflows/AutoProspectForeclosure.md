...
const FROM\_NAME      = "Jacob Levy | Home\-Link Realty Group";

const FROM\_EMAIL     = "jacob\.levy@homelinkrealtygroup\.com";

const FROM           = \`$\{FROM\_NAME\} <$\{FROM\_EMAIL\}>\`;
...
            <p style="margin:0;"><a href="tel:\+18558101786" style="color:\#e63946;text\-decoration:none;">$\{PHONE\}</a> | <a href="mailto:$\{FROM\_EMAIL\}" style="color:\#e63946;text\-decoration:none;">$\{FROM\_EMAIL\}</a></p>
