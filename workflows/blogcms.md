...
  \}, \[form\.title, form\.content, form\.meta\_description\]\);
...
      schema\_markup: JSON\.stringify\(schemaData\),
...
              value=\{form\.image\_url\}

              onChange=\{\(e\) => setForm\(\{ \.\.\.form, image\_url: e\.target\.value \}\)\}
...
              <strong>Meta Title:</strong> \{form\.meta\_title || "\(auto\-generated\)"\}

            </div>

            <div style=\{\{ fontSize: 12, color: "\#888", marginTop: 6 \}\}>

              <strong>Description:</strong> \{form\.meta\_description || "\(auto\-generated\)"\}
...
              value=\{form\.meta\_title\}

              onChange=\{\(e\) => setForm\(\{ \.\.\.form, meta\_title: e\.target\.value \}\)\}
...
              \{form\.meta\_title\.length\}/60 chars
...
              value=\{form\.meta\_keywords\}

              onChange=\{\(e\) => setForm\(\{ \.\.\.form, meta\_keywords: e\.target\.value \}\)\}
...
            value=\{form\.meta\_description\}

            onChange=\{\(e\) => setForm\(\{ \.\.\.form, meta\_description: e\.target\.value \}\)\}
...
            \{form\.meta\_description\.length\}/160 chars
