...
const TWILIO\_PHONE = '\+19729941658';

const AGENT\_PHONE = Deno\.env\.get\('AGENT\_PHONE'\) || '\+13374857368';

const CALL\_DELAY = 5000; // 5 second delay between calls
...
      await new Promise\(r => setTimeout\(r, CALL\_DELAY\)\);
