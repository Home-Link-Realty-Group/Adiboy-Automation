...
const PLATFORMS = [
  ...
  { name: 'Twitter/X', icon: '🐦', color: '#1DA1F2', status: 'not_connected', followers: 0, posts: 0, engagement: '0%' },

  { name: 'YouTube', icon: '▶️', color: '#FF0000', status: 'not_connected', followers: 0, posts: 0, engagement: '0%' },
