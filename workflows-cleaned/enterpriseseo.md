...
import { setMeta, setSchema, SITE_URL } from "@/lib/seoHelpers";
...
export function useEnterpriseSEO({
  ...
  useEffect(() => {
    ...
    hrefLang.href = `${SITE_URL}${canonicalPath}`;
    ...
    hrefDefault.href = `${SITE_URL}${canonicalPath}`;
    ...
    if (city && state) {
      ...
      setSchema(`schema-localbusiness-${city.toLowerCase().replace(/\s+/g, "-")}`, {
        ...
        "@id": `${SITE_URL}${canonicalPath}#localbusiness`,
        ...
        image: "https://media.base44.com/images/public/69d48de0b96337e8cdc27f54/341fa67b3_generated_image.png",
    ...
    if (article) {
      ...
      setSchema("schema-article", {
        ...
        image: article.image || "https://media.base44.com/images/public/69d48de0b96337e8cdc27f54/341fa67b3_generated_image.png",
        ...
        publisher: {
          ...
          logo: { "@type": "ImageObject", url: "https://media.base44.com/images/public/69d48de0b96337e8cdc27f54/341fa67b3_generated_image.png" },
