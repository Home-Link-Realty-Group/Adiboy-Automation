...

{
  ...
  "toneAssessment": {
    ...
    "urgency": "appropriate|too_high|too_low"
...

{
  ...
  "scriptTrackStatus": "on_track|drifting|off_track",
...
async function createFollowUpTask(base44, leadId, followUpPlan) {
  ...
  try {
    ...
    const followUp = await base44.entities.FollowUp.create({
      ...
      script_template: followUpPlan.touchMessage,

      status: 'Scheduled',

      next_action: followUpPlan.touchMessage,
