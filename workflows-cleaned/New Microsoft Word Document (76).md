# New Microsoft Word Document (76)

Source: New Microsoft Word Document (76).docx
...
const PUBLISH_DESTINATIONS = [
  ...
  { name: "Facebook", icon: "📘", color: "#1877F2", url: "https://www.facebook.com/" },

  { name: "Instagram", icon: "📸", color: "#E1306C", url: "https://www.instagram.com/" },

  { name: "LinkedIn", icon: "💼", color: "#0A66C2", url: "https://www.linkedin.com/feed/" },

  { name: "X / Twitter", icon: "🐦", color: "#000000", url: "https://twitter.com/compose/tweet" },

  { name: "Google My Business", icon: "📍", color: "#4285F4", url: "https://business.google.com/" },

  { name: "Meta Ads Manager", icon: "💰", color: "#0668E1", url: "https://adsmanager.facebook.com/" },
...
const Card = ({ children, style = {} }) => (
  ...
  <div style={{ background: "linear-gradient(145deg, #0f1826, #0d1520)", border: "1px solid #0B1F45", borderRadius: 16, overflow: "hidden", ...style }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(120px, 1fr))", gap: 8 }}>
              ...
              {PUBLISH_DESTINATIONS.map(d => (
                ...
                <a key={d.name} href={d.url} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
                  ...
                  <div style={{ background: "#0a111e", border: `1px solid ${rgba(d.color, 0.3)}`, borderRadius: 8, padding: "10px 8px", textAlign: "center", transition: "all 0.15s" }}
