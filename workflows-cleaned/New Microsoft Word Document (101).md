# New Microsoft Word Document (101)

Source: New Microsoft Word Document (101).docx

import { useState } from "react";

import { PHONE, PHONE_RAW, FAQS } from "./portalConstants";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{ background: "linear-gradient(135deg, #f0fff4, #dcfce7)", borderRadius: 20, padding: "28px 32px", border: "1px solid #bbf7d0", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
          ...
          <a href={`tel:${PHONE_RAW}`} style={{ padding: "13px 28px", background: "#27ae60", borderRadius: 12, color: "#fff", fontWeight: 700, textDecoration: "none", fontSize: 15 }}>📞 Call {PHONE}</a>
