...
const SOPS = [
    ...
    steps: [

      {
        ...
        checklist: [
          ...
          "✅ Twilio active (TWILIO_ACCOUNT_SID + AUTH_TOKEN set)",

          "✅ Your personal cell (337) 485-7368 is correct in the function",

          "✅ Resend API key active (re_jPnZkjQk...)",
...

      {
        ...
        checklist: [
          ...
          "[ ] Step 3: Get the Form ID from Meta and add to .env as META_LEAD_FORM_ID",
...

      {
        ...
        checklist: [
          ...
          "[ ] Add SLYBROADCAST_API_KEY or DROPCOWBOY_API_KEY",
    ...
    steps: [
...

      {
        ...
        checklist: [
          ...
          "Contact support or add META_LEAD_FORM_ID to your app secrets",
...

  {
    ...
    prereqs: ["Apify account active (APIFY_API_TOKEN set)", "Leads already imported to CRM WITHOUT phone numbers"],
    ...
    steps: [
...

      {
        ...
        checklist: [
          ...
          "Add: SLYBROADCAST_API_KEY = [your key]",

          "OR add: DROPCOWBOY_API_KEY = [your key]",
