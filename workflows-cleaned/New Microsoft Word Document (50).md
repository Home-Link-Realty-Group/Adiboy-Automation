        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {analytics && (
            ...
            <div style={{ fontSize: 10, color: "#1e3a5f", textAlign: "right" }}>
              ...
              <div style={{ color: "#334155" }}>{new Date(analytics.fetched_at).toLocaleTimeString("en-US", { timeZone: "America/Chicago", hour: "2-digit", minute: "2-digit" })} CT</div>
        ...
        return (
          ...
          <div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderTop: "1px solid #0a111e", fontSize: 10, color: "#1e3a5f" }}>
              ...
              <span>Last refreshed: {new Date(analytics.fetched_at).toLocaleString("en-US", { timeZone: "America/Chicago", dateStyle: "short", timeStyle: "short" })} CT</span>
