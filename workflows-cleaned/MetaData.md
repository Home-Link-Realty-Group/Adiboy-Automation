...
- meta_title (50-60 chars): Catchy, keyword-rich title with category context

- meta_description (150-160 chars): Compelling description with call-to-action

- meta_keywords: 5-7 comma-separated keywords related to title, category, and content
...
Focus on: real estate selling, cash offers, foreclosure help, inherited properties.`;
  ...
  try {
    ...
    return {
      ...
      meta_keywords: "real estate, cash home buyer, sell house fast",
...
export const analyzeSEOScore = (title, content, meta_description) => {
  ...
  if (
    ...
    issues.push(`Meta description is ${meta_description.length} chars (target: 150-160)`);
